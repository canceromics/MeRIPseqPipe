...
control_database = read.table(paste0("featurecount_",aligner,"_group_", group_id_1, "_input.count"), header = TRUE, row.names = 1)
treated_database = read.table(paste0("featurecount_",aligner,"_group_", group_id_2, "_input.count"), header = TRUE, row.names = 1)
...
output_name <- paste0("edgeR_group_",aligner,"_",group_id_1, "_",group_id_2)
